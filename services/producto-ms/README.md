...
```powershell
docker exec -it ecom-postgres-producto-dev psql -U ecom -d ecom_producto_db

docker exec -it ecom-postgres-producto-dev psql -U ecom -d ecom_producto_db -c "\dt"
docker exec -it ecom-postgres-producto-dev psql -U ecom -d ecom_producto_db -c "\d productos"
docker exec -it ecom-postgres-producto-dev psql -U ecom -d ecom_producto_db -c "SELECT * FROM productos;"
```

En PROD usa el contenedor `ecom-postgres-producto`.
