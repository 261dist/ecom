...
```powershell
docker exec -it ecom-postgres-orden-dev psql -U ecom -d ecom_orden_db

docker exec -it ecom-postgres-orden-dev psql -U ecom -d ecom_orden_db -c "\dt"
docker exec -it ecom-postgres-orden-dev psql -U ecom -d ecom_orden_db -c "\d ordenes"
docker exec -it ecom-postgres-orden-dev psql -U ecom -d ecom_orden_db -c "SELECT * FROM ordenes;"
```

En PROD usa el contenedor `ecom-postgres-orden`.
