...
### 7.4 Realiza la práctica intermedia con Python

Usa el proyecto `orden-py` para reforzar el patrón producer/consumer con menos complejidad que Spring Boot.
...
- los mensajes lleguen al tópico `orden-eventos`
